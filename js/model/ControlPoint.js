...
define( function( require ) {
  ...
  return inherit( PropertySet, ControlPoint, {
    copy: function() {
        return new ControlPoint( this.position.x, this.position.y , {snapTarget: null} );    },
    copyWithSnap: function() {
        return new ControlPoint( this.position.x, this.position.y , {snapTarget: this.snapTarget} );  }
  } );
} );
