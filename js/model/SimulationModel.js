...
//    this.previousTracks = null; //stored value of previously used tracks
    ...
    this.mergedTrackCount = mergedTrackCount;
      ...
      var drop, bank, hill, loop, flat;
        ...
        var bankTrack = new Track( this, this.tracks, bank, true, null, this.availableModelBoundsProperty, {trackName:'Bank', hScale: vSc1, vScale: hSc1, vRange: new Range(0,1)} );
      ...
      var dropTrack2 = new Track( this, this.tracks, drop, true, null, this.availableModelBoundsProperty,{trackName:'Drop2', hScale: vSc1, vScale: hSc1} );
...
//      slopeTrack.slopeToGround = true;
	...
	this.allTracks.addAll([dropTrack, dropTrack2, bankTrack, hillTrack, loopTrack]);
